...
## Deploy to GitHub Pages with your domain (slpio.com)
...
4. Under "Custom domain", enter `slpio.com` and save (GitHub will detect the `CNAME` file already included here).
5. At your domain registrar (wherever you bought slpio.com), add these DNS records:
...
Once DNS propagates, your site will be live at `https://slpio.com`.

## Files

- `index.html` — the entire site (calculator + about/contact/privacy/terms/disclaimer content, all self-contained)
- `CNAME` — tells GitHub Pages to serve this repo at slpio.com
...
- All canonical URLs, Open Graph tags, and schema markup already point to `https://slpio.com/`.
